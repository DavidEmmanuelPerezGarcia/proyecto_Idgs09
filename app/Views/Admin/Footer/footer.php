<div class="footer-copyright-area">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right" style="    position: absolute; left: 50%; transform: translateX(-80%);">
	...
	<!-- float JS
		============================================ -->
    <script src="<?php echo base_url();?>/public/js/flot/jquery.flot.js"></script>
    <script src="<?php echo base_url();?>/public/js/flot/jquery.flot.resize.js"></script>
    <script src="<?php echo base_url();?>/public/js/flot/curvedLines.js"></script>
    <script src="<?php echo base_url();?>/public/js/flot/flot-active.js"></script><div class="flot-tooltip"></div><div class="flot-tooltip"></div><div class="flot-tooltip"></div>
    <!-- plugins JS
		============================================ -->
